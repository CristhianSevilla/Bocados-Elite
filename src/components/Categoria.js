...
const Categoria = ({ categoria }) => {
    ...
    return (
        <div className={`${categoriaActual?.id === id ? 'bg-amber-800 text-amber-100' : 'text-amber-950'} w-full border border-black border-x-0 last-of-type:border-b-2 transition-bg transition-text duration-300 hover:bg-amber-800 hover:text-amber-100`}>
            <button
                type="button"
